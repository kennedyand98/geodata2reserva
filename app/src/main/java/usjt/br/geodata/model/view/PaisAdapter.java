...
import usjt.br.geodata.R;
import usjt.br.geodata.model.entity.Pais;

import static usjt.br.geodata.R.drawable.bandeira;
...
public class PaisAdapter extends BaseAdapter implements SectionIndexer {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Drawable drawable = usjt.br.geodata.model.view.Util.getDrawable(activity, paises[position].getCodigo3().toLowerCase());
        if(drawable == null){
